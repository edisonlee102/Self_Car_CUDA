...
/build/python_communicate_with_C++.py is example code that we read frame from test.avi in python and parsing into C++ make it become  gray level then back to python.
API:QciToGray_GPU(cv2::Mat)
Please follow the example to add your API.
```
